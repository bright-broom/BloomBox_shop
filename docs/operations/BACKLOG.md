...
| P1-07 | Dependabot更新処理の失敗調査 | 実行34572684620がfailure。アプリCIは成功 | 更新ジョブのログを調査して原因解消。アプリのCI失敗と混同しない |
...
| P2-06 | クーポン・販促・分析・推薦 | 割引はProviderを正とする。効果測定の目的・同意・最小データを定義。分析/AI障害で購入を止めない |
