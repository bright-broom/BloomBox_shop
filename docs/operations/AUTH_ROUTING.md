...
> 後続の実接続確認：同日、3025番へ既存Google OAuthと顧客DBを接続し、実Googleの2顧客で本人のマイページ・注文の相互非表示・ログアウトを確認しました。[接続完了記録](CUSTOMER_GOOGLE_3025_VERIFICATION.md)を参照。以下の「設定調整待ち」は導線修正時点の履歴です。
