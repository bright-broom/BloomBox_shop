...
export const giftExperienceSchema = z.object({
  ...
  cart: z.object({ removeError: copy, shippingUnavailable: copy, cancelPending: copy, cancelFailed: copy, checkoutCancelledHint: copy, completedNotice: copy, previousOrderKeptNotice: copy, checkoutRestartRequired: copy, orderAlreadyCompleted: copy }),
